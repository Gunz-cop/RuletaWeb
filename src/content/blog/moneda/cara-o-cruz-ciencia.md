...
1. **El sesgo del inicio:** Una moneda lanzada al aire tiene una probabilidad ligeramente mayor de aterrizar **en el mismo lado en el que estaba apoyada en el dedo** antes del lanzamiento. Diaconis estimó esta probabilidad en aproximadamente un **51% contra 49%**.
2. **El movimiento de rotación (precesión):** Cuando la moneda gira en el aire, no solo rota de punta a punta, sino que también experimenta precesión (como un trompo que se tambalea). Esto hace que una de las caras pase más tiempo mirando hacia arriba durante la trayectoria de vuelo.
